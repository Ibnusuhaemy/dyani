                    ...
                    <div class="col-md-6 tile-active">
                        <a class="tile tile-pink" data-stop="3000" href="http://codecanyon.net/item/flaty-wp-premium-wordpress-flat-admin-template/5329999">
                            <div class="img img-center">
                                <img src="{{ asset('img/demo/wp-logo.png') }}" />
                            </div>
        ...
        <div class="box box-magenta">
            ...
            <div class="box-content">
                <ul class="messages slimScroll" style="height: 300px">
                    <li>
                        <img src="{{ asset('img/demo/avatar/avatar2.jpg') }}" alt="">
                        <div>
                            <div>
                                <h5>David</h5>
                    ...
                    <li>
                        <img src="{{ asset('img/demo/avatar/avatar3.jpg') }}" alt="">
                        <div>
                            <div>
                                <h5>Sarah</h5>
                    ...
                    <li>
                        <img src="{{ asset('img/demo/avatar/avatar4.jpg') }}" alt="">
                        <div>
                            <div>
                                <h5>Emma</h5>
                    ...
                    <li>
                        <img src="{{ asset('img/demo/avatar/avatar5.jpg') }}" alt="">
                        <div>
                            <div>
                                <h5>John</h5>
                    ...
                    <li>
                        <img src="{{ asset('img/demo/avatar/avatar1.jpg') }}" alt="">
                        <div>
                            <div>
